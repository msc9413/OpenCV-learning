...
void main() {
	...
	Mat img(512, 512, CV_8UC3, Scalar(255, 255, 255));//(512,512)为图片大小，CV8UC3中8U表示每个像素的值从0到255，3表示3个颜色通道BGR,Scalar(255, 0, 0)表示图像的颜色
	...
	// 要绘制的图片 文字内容  起始点  字体  大小   颜色   厚度
	putText(img, "moshaocong莫少聪", Point(137, 262), FONT_HERSHEY_DUPLEX, 0.75, Scalar(0, 69, 255), 2);
